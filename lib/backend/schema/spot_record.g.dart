...
class SpotRecordBuilder implements Builder<SpotRecord, SpotRecordBuilder> {
  ...
  double _spot;
  double get spot => _$this._spot;
  set spot(double spot) => _$this._spot = spot;
  ...
  double _spotCentro;
  double get spotCentro => _$this._spotCentro;
  set spotCentro(double spotCentro) => _$this._spotCentro = spotCentro;
